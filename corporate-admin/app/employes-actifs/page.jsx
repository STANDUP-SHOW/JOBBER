  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Employés actuellement en mission. Voir <Link href="/employes" className="font-medium text-brand hover:underline">Mes employés OFF</Link> pour tout votre vivier.
      </p>
