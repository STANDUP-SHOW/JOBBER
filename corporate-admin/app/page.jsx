  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Demandes soumises via {brand.name}, en attente de votre décision : publier sur Jobber ou traiter en direct via l'agence.
      </p>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <Link href={`/missions/${m.id}`} className="font-display text-base font-semibold text-ink hover:underline">
                      {m.title}
                    </Link>
                    {m.corporateCode && (
