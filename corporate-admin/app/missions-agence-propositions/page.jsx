  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Devis envoyés au client pour une mission agence, en attente de son acceptation depuis son compte {brand.name}.
      </p>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  <div className="font-medium text-ink">
                    {m.category?.icon} <Link href={`/missions/${m.id}`} className="hover:underline">{m.title}</Link>
                  </div>
