  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Tout votre vivier de confiance. Voir <Link href="/employes-actifs" className="font-medium text-brand hover:underline">Mes employés ON</Link> pour ceux actuellement en mission.
      </p>
