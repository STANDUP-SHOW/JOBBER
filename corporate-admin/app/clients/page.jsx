  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Les visiteurs de {brand.name} qui ont créé un compte et publié au moins un besoin.
      </p>
          ...
          {clients.map((c) => (
            <div key={c.id} className="rounded-lg border border-slate-200 bg-white p-4">
              ...
              <div className="mt-3 flex gap-2">
                <Link href={`/clients/${c.id}`} className="flex-1 rounded-md border border-slate-200 py-1.5 text-center text-xs font-medium text-ink hover:border-brand">
                  Voir le profil
                </Link>
