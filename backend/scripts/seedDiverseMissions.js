...
const TASKS = [
  ...
  // JARDINAGE (3)
  { categorySlug: 'jardinage', title: 'Taille de haies et tonte', description: "Taille de haies de thuyas et tonte d'un jardin de 300 m².", address: '11 Chemin des Vignes, 34290 Servian', desiredDate: daysFromNow(6, 8, 0), estimatedHours: 3, isUrgent: false, datesFlexible: true, equipmentCount: 2, requiredVehicleTypes: ['PETIT_UTILITAIRE_4M3'] },
  ...
  { categorySlug: 'jardinage', title: 'Taille annuelle des arbres fruitiers', description: "Taille de 6 arbres fruitiers avant la période de floraison, deux passages par an.", address: '22 Rue de la Liberté, 34450 Vias', desiredDate: daysFromNow(14, 9, 0), estimatedHours: 4, isUrgent: false, datesFlexible: true, isRecurring: true, recurrenceCount: 2, recurrenceUnit: 'AN' },
  ...
  { categorySlug: 'convoi', title: 'Convoyage poids lourd concession', description: "Convoyage d'un camion depuis une concession jusqu'au dépôt client.", address: '15 Rue du Château, Pézenas', dropoffAddress: '11 Chemin des Vignes, 34290 Servian', desiredDate: daysFromNow(9, 10, 0), estimatedHours: 3, isUrgent: false, datesFlexible: false, requiredVehicleTypes: ['POIDS_LOURD'] },
  ...
  { categorySlug: 'transport', title: 'Transport gravats déchetterie', description: "Transport de gravats de travaux jusqu'à la déchetterie la plus proche.", address: '7 Rue des Écoles, Vias', dropoffAddress: '21 Rue de la Liberté, 34450 Vias', desiredDate: daysFromNow(3, 8, 0), estimatedHours: 2, isUrgent: false, datesFlexible: true, requiredVehicleTypes: ['CAMION_BENNE'] },
  ...
  { categorySlug: 'peinture', title: 'Ravalement façade petite maison', description: "Peinture extérieure d'une façade de maison de plain-pied, environ 40 m².", address: '11 Chemin des Vignes, 34290 Servian', desiredDate: daysFromNow(18, 9, 0), estimatedHours: 8, isUrgent: false, datesFlexible: true, requiredVehicleTypes: ['PETIT_UTILITAIRE_4M3'] },

  // PISCINE (2)
  { categorySlug: 'piscine', title: 'Remise en état piscine avant été', description: "Remise en état complète d'une piscine hors sol après l'hiver : nettoyage, traitement, vérification.", address: '21 Rue de la Liberté, 34450 Vias', desiredDate: daysFromNow(4, 9, 0), estimatedHours: 3, isUrgent: true, datesFlexible: true, equipmentCount: 2 },
...
const LESSONS = [
  ...
  { categorySlug: 'jardinage', title: 'Cours de jardinage hebdomadaire', description: "Je veux apprendre à entretenir mon potager pas à pas, une séance chaque semaine.", address: '22 Rue de la Liberté, 34450 Vias', desiredDate: daysFromNow(7, 9, 0), estimatedHours: 1.5, isRecurring: true, recurrenceCount: 1, recurrenceUnit: 'SEMAINE' },
  ...
  { categorySlug: 'peinture', title: 'Cours pose de papier peint', description: "Débutant, je souhaite apprendre à poser du papier peint correctement, découpe et raccords compris.", address: '11 Chemin des Vignes, 34290 Servian', desiredDate: daysFromNow(13, 10, 0), estimatedHours: 3, datesFlexible: false },
  ...
  { categorySlug: 'piscine', title: 'Apprendre à entretenir sa piscine soi-même', description: "Je veux apprendre à analyser l'eau et entretenir ma piscine sans faire venir quelqu'un chaque semaine.", address: '21 Rue de la Liberté, 34450 Vias', desiredDate: daysFromNow(5, 10, 0), estimatedHours: 2, datesFlexible: true },
