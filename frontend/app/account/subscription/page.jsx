...
export default function SubscriptionPage() {
  ...
  const PLANS = isCompany ? COMPANY_PLANS : INDIVIDUAL_PLANS;
  ...
  return (
    <div className="mx-auto max-w-xl">
      ...
      <h1 className="mt-3 font-display text-2xl font-semibold text-ink">{isCompany ? 'Abonnement Entreprise' : 'Abonnement Manager'}</h1>
