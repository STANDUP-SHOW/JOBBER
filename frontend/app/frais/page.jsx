...
const description =
  "Parlons argent. La version gratuite de Jobber donne accès à toutes les fonctionnalités : 2,50 € au demandeur et 2,50 € au jobber par mission réalisée, ou plus aucun frais avec une carte.";
    ...
    <div>
      ...
      <section className="mx-auto mt-16 max-w-2xl text-center">
        ...
        <p className="mt-3 font-semibold text-ink">
          ...
          cartes, la seule chose qui change, ce sont les prélèvements sur vos missions.
        </p>
      </section>

      <section className="mt-16 rounded-lg border border-slate-200 bg-white p-6 text-center md:p-10">
        <h2 className="font-display text-2xl font-semibold text-moss">Sans aucune carte</h2>
        <p className="mx-auto mt-3 max-w-xl text-lg text-ink">
          ...
          au jobber. Le manager et le jobber peuvent prendre une carte pour ne plus avoir aucun frais à payer sur
          leurs missions.
        </p>
        <div className="mx-auto mt-6 max-w-xl rounded-lg bg-ink p-5 text-left">
          <p className="text-sm font-bold text-ochre">
            Concernant la formule sans carte à 2,50 € la mission : vous n'aurez jamais rien à payer à Jobber —
      ...
      <section className="mt-16 grid gap-10 sm:grid-cols-2">
        <PlanTable title="Récapitulatif des cartes — Manager" plans={MANAGER_PLANS} />
        <PlanTable title="Récapitulatif des cartes — Jobber" plans={JOBBER_PLANS} />
      </section>
      ...
      <section className="mt-16 mb-4 rounded-lg bg-ink py-10 px-6 text-center text-white md:px-12">
        ...
        <p className="mx-auto mt-2 max-w-xl text-white/80">
          Gérez votre carte directement depuis votre compte.
        </p>
        <div className="mt-6">
