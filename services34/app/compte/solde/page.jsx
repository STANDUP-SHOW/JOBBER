...
export default function SoldePage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) router.push('/auth/login?next=/compte/solde');
  ...
  return (
    <div className="mx-auto max-w-xl">
      ...
      <div className="mt-4 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500">Montant total disponible pour payer vos prochaines prestations.</p>
      </div>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        ...
        <div className="rounded-2xl bg-ink p-4 text-white">
          ...
          <Link href="/compte/cesu" className="mt-3 block w-full rounded-full bg-white py-2 text-center text-xs font-semibold text-ink">
            + Voir plus
          </Link>
        </div>
      </div>
