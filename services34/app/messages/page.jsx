...
export default function MessagesListPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <span className="text-sm font-semibold uppercase tracking-wide text-brand">Messagerie</span>
      ...
      <div className="mt-6 space-y-2">
        ...
        {conversations.map((c) => {
          ...
          return (
            <Link key={c.id} href={`/messages/${c.id}`} className="block rounded-lg border border-slate-200 bg-white p-4 hover:border-brand">
