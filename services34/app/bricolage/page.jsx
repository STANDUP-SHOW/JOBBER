...
export default function BricolagePage() {
  return (
    ...
    <ServiceCategoryPage
      ...
      tasks={[
        { name: 'Montage de meubles', href: '/bricolage/montage-de-meubles', icon: '🪑' },
        { name: 'Assemblage IKEA', href: '/bricolage/assemblage-ikea', icon: '📦' },
        { name: "Fixation d'étagères", href: '/bricolage/fixation-etageres', icon: '📐' },
        { name: 'Accrocher un tableau ou un miroir', href: '/bricolage/accrocher-tableau-miroir', icon: '🖼️' },
        { name: 'Pose de tringles à rideaux', href: '/bricolage/pose-tringles-rideaux', icon: '🪟' },
        { name: 'Remplacer une porte ou une poignée', href: '/bricolage/remplacer-porte-poignee', icon: '🚪' },
        { name: 'Pose de crédence', href: '/bricolage/pose-credence', icon: '🧱' },
        { name: 'Peinture intérieure', href: '/bricolage/peinture-interieure', icon: '🎨' },
        { name: 'Pose de papier peint', href: '/bricolage/pose-papier-peint', icon: '🖌️' },
        { name: 'Boucher un trou, enduire un mur', href: '/bricolage/boucher-trou-enduire-mur', icon: '🧰' },
        { name: "Petits travaux d'électricité", href: '/bricolage/petits-travaux-electricite', icon: '💡' },
        { name: 'Petits travaux de plomberie', href: '/bricolage/petits-travaux-plomberie', icon: '🚰' },
        { name: 'Installation électroménager', href: '/bricolage/installation-electromenager', icon: '🔌' },
        { name: 'Serrurerie', href: '/bricolage/serrurerie', icon: '🔑' },
        { name: 'Isolation de porte ou fenêtre', href: '/bricolage/isolation-porte-fenetre', icon: '🌬️' },
        { name: 'Petites réparations diverses', href: '/bricolage/petites-reparations', icon: '🔧' },
      ]}
      faq={[
