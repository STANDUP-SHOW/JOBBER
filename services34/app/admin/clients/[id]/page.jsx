...
export default function AdminClientDetailPage() {
  ...
  return (
    <div className="max-w-2xl">
      <Link href="/admin/clients" className="text-sm text-slate-400 hover:text-brand">← Membres inscrits</Link>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-lg border border-brand/30 bg-brand/5 p-4 text-center sm:col-span-2">
          ...
          <div className="text-xs text-brand">Montant dépensé via Services 34</div>
        </div>
      </div>
