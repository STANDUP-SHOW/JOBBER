...
export default function TaxCreditSimulator() {
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6">
      <div className="space-y-6">
        <div>
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="rounded-full bg-brand px-3 py-1 text-xs font-semibold text-white">{hours} h</span>
          </div>
          <input
        ...
        <div>
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium text-ink">Tarif horaire net de l'agent</span>
            <span className="rounded-full bg-brand px-3 py-1 text-xs font-semibold text-white">{rate} €</span>
          </div>
          <input
      ...
      <div className="mt-3 flex items-start gap-2 rounded-md bg-brand-light px-3 py-2.5 text-sm text-brand-dark">
        <span>✓</span>
...
function Row({ label, value, bold, highlight }) {
  return (
    <div className="flex items-center justify-between">
      ...
      <span className={bold ? 'font-semibold text-ink' : highlight ? 'font-medium text-brand-dark' : 'text-ink'}>{value}</span>
    </div>
  );
}
