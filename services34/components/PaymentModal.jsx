  ...
  if (succeeded) {
    return (
      <div className="py-6 text-center">
        ...
        <p className="mt-2 text-sm font-medium text-brand">Paiement autorisé — les fonds sont bloqués en séquestre.</p>
      </div>
    );
  }
    ...
    <form onSubmit={onSubmit}>
      ...
      <div className="mt-4 flex gap-2">
        <button
          type="button"
          onClick={onClose}
          className="flex-1 rounded-md border border-slate-200 py-3 text-sm font-medium text-ink hover:border-brand"
        >
          Annuler
        </button>
        <button
          ...
          className="flex-1 rounded-md bg-brand py-3 text-sm font-semibold text-white hover:opacity-90 disabled:opacity-60"
        >
